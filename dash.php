...
<title>Final Project Quiz  || DASHBOARD </title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Quiz Interaktif</span></div>
<?php
...
<tr style="color:red"><td><b>Rank</b></td><td><b>Name</b></td><td><b>Kelamin</b></td><td><b>Kampus</b></td><td><b>Score</b></td></tr>';
$c=0;
...
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>No.</b></td><td><b>Name</b></td><td><b>Kelamin</b></td><td><b>kampus</b></td><td><b>Email</b></td><td><b>Nomor HP</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$mob = $row['mob'];
...
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Detail Quiz</b></span><br /><br />
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Judul Quiz" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="total" name="total" placeholder="Jumlah Soal Quiz" class="form-control input-md" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="right" name="right" placeholder="Total Pilihan Jawaban" class="form-control input-md" min="0" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="wrong" name="wrong" placeholder="Nilai Minus pada jawaban yang salah" class="form-control input-md" min="0" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="time" name="time" placeholder="Waktu Pengerjaan" class="form-control input-md" min="1" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="tag" name="tag" placeholder="Masukkan #tag untuk pencarian" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <textarea rows="8" cols="8" name="desc" class="form-control" placeholder="Deskripsi Quiz..."></textarea>  
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <textarea rows="3" cols="5" name="qns'.$i.'" class="form-control" placeholder="Tulis Soal Quiz '.$i.' Disini..."></textarea>  
  </div>
</div>
<!-- Text input-->
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="'.$i.'1" name="'.$i.'1" placeholder="Masukkan Jawaban a" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="'.$i.'2" name="'.$i.'2" placeholder="Masukkan Jawaban b" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="'.$i.'3" name="'.$i.'3" placeholder="Masukkan Jawaban c" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="'.$i.'4" name="'.$i.'4" placeholder="Masukkan Jawaban d" class="form-control input-md" type="text">
...
<select id="ans'.$i.'" name="ans'.$i.'" placeholder="Choose correct answer " class="form-control input-md" >
   <option value="a">Pilih Jawaban Untuk Quiz '.$i.'</option>
